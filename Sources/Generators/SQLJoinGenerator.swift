...
class SQLJoinGenerator: SQLElementGenerator<SQLJoin> {
    
    private func typeString(_ type: SQLJoin.JoinType) -> String {
        switch type {
    ...
    override func generate(_ element: SQLJoin, forRead: Bool) -> String {
    ...
    override func generateFormatted(_ element: SQLJoin,
                                    forRead: Bool,
