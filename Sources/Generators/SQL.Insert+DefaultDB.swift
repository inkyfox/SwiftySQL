...
extension SQL.Insert {
    ...
    class Generator: SQLQueryGenerator<SQL.Insert> {
        ...
        override func generate(_ element: SQL.Insert, forRead: Bool) -> String {
            return generateQuery(element, forRead: forRead)
        }
        
        override func generateFormatted(_ element: SQL.Insert,
                                        forRead: Bool,
                                        withIndent indent: Int) -> String {
            return generateFormattedQuery(element, forRead: forRead, withIndent: indent)
        }
        
        override func generateQuery(_ element: SQL.Insert, forRead: Bool) -> String {
        ...
        override func generateFormattedQuery(_ element: SQL.Insert,
                                             forRead: Bool,
                                             withIndent indent: Int) -> String {
            var query = actionString(element.action) + " INTO "
