...
class SQLTernaryExprGenerator: SQLElementGenerator<SQLTernaryExpr> {
    
    override func generate(_ element: SQLTernaryExpr, forRead: Bool) -> String {
    ...
    override func generateFormatted(_ element: SQLTernaryExpr,
                                    forRead: Bool,
